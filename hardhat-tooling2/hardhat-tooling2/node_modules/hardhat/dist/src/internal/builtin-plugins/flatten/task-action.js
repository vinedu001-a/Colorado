...
function throwIfCycle(file, importChain) {
    ...
    throw new HardhatError(HardhatError.ERRORS.CORE.BUILTIN_TASKS.FLATTEN_CYCLIC_DEPENDENCY, { cycle });
}
