 ...
 */
export declare function getDevDependenciesInstallationCommand(packageManager: PackageManager, dependencies: string[], packageManagerMajorVersion?: number): string[];
/**
...
export declare function getVersion(workspace: string, packageManager: PackageManager, version?: string): Promise<SemverVersion | undefined>;
export {};
