 ...
 */
export function getDevDependenciesInstallationCommand(packageManager, dependencies, packageManagerMajorVersion) {
...
export async function getVersion(workspace, packageManager, version) {
